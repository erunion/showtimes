...
class fandango extends engine {
  ...
  /*_parseTheater ($, theater, alternate, theaterId) {
    ...
    if (alternate) {
      ...
      if (showtimes.showtime_tickets) {
        theaterData.showtime_tickets = showtimes.showtime_tickets
      }
   ...
   *                             logic.
   * @param  {string}  movieId   If calling this from getMovie(), this is a movie ID representation for the movie you
   *                             are parsing.
